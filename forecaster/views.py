...
def task_create(request, project_id):
    ...
    if request.method == 'POST':
        ...
        form = TaskForm()
    return render(request, 'forecaster/task_form.html', {'form': form, 'project_id': project.pk})
...
def task_edit(request, pk):
    ...
    return render(request, 'forecaster/task_form.html', {'form': form, 'project_id': task.project.pk})